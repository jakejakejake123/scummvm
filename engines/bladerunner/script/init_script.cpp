...
void InitScript::Init_SDB() {
	...
	if (_vm->_cutContent) {
		...
		SDB_Add_Other_Clue(kSuspectSadik, kClueMcCoyIsKind);
		SDB_Add_Other_Clue(kSuspectSadik, kCluePhoneCallDektora2);
	...
	if (_vm->_cutContent) {
		...
		SDB_Add_Other_Clue(kSuspectClovis, kClueMcCoyIsKind);
		SDB_Add_Other_Clue(kSuspectClovis, kClueMcCoyHelpedIzoIzoIsAReplicant);
		SDB_Add_Other_Clue(kSuspectClovis, kClueMcCoyHelpedDektora);
		SDB_Add_Other_Clue(kSuspectClovis, kClueMcCoyIsABladeRunner);
		SDB_Add_Other_Clue(kSuspectClovis, kCluePhoneCallLucy2);
		SDB_Add_Other_Clue(kSuspectClovis, kClueMoonbusCloseup);
	...
	if (_vm->_cutContent) {
		SDB_Add_Identity_Clue(kSuspectIzo, kClueWeaponsCache);
	}
	...
	SDB_Add_Other_Clue(kSuspectIzo, kClueMcCoyHelpedIzoIzoIsAReplicant);
	...
	if (_vm->_cutContent) {
		...
		SDB_Add_MO_Clue(kSuspectIzo, kClueShellCasings);
		SDB_Add_Replicant_Clue(kSuspectIzo, kClueBobShotInColdBlood);
		SDB_Add_Identity_Clue(kSuspectIzo, kCluePoliceWeaponUsed);
		SDB_Add_MO_Clue(kSuspectIzo, kClueShellCasings);
		SDB_Add_Whereabouts_Clue(kSuspectIzo, kClueChinaBar);
		SDB_Add_Other_Clue(kSuspectIzo, kCluePhotoOfMcCoy1);
		SDB_Add_Other_Clue(kSuspectIzo, kCluePhotoOfMcCoy2);
		SDB_Add_Other_Clue(kSuspectIzo, kClueIzosFriend);	
		SDB_Add_Other_Clue(kSuspectIzo, kClueHomelessManInterview1);
		SDB_Add_Identity_Clue(kSuspectIzo, kClueMoonbus1);
	...
	if (_vm->_cutContent) {
		...
		SDB_Add_Identity_Clue(kSuspectCrazylegs, kClueCrazylegsInterview2);
		...
		SDB_Add_Identity_Clue(kSuspectCrazylegs, kClueCarRegistration1);
		SDB_Add_Identity_Clue(kSuspectCrazylegs, kClueCarRegistration3);
	...
	if (_vm->_cutContent) {
		...
		SDB_Add_Other_Clue(kSuspectGrigorian, kClueGrigoriansNote);
...
void InitScript::Init_CDB() {
	...
	if (_vm->_cutContent) {
		...
		CDB_Set_Crime(kClueCrystalVisitedRunciters, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueRunciterConfession1, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueCrazylegsInterview1, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueCrazylegsInterview2, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueLicensePlateMatch, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueCar, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueCarWasStolen, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueCarIdentified, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueRunciterConfession2, kCrimeAnimalMurder);
		CDB_Set_Crime(kClueZubensMotive, kCrimeAnimalMurder);
	}
	if (!_vm->_cutContent) {
	...
	if (_vm->_cutContent) {
		CDB_Set_Crime(kClueCandyWrapper, kCrimeRunciterMurder);
	}

	if (_vm->_cutContent) {
		CDB_Set_Crime(kClueBobShotInColdBlood, kCrimeBobMurder);
		CDB_Set_Crime(kCluePoliceWeaponUsed, kCrimeBobMurder);
		CDB_Set_Crime(kClueWeaponsCache, kCrimeBobMurder);
	}
...
void InitScript::Init_Actor_Intelligence() {
	if (_vm->_cutContent) {
		if (Game_Flag_Query(kFlagZubenIsReplicant)) {
			Actor_Set_Intelligence(kActorZuben, 10);
		} else {
			Actor_Set_Intelligence(kActorZuben, 30);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorGordo, 60);
		} else {
			Actor_Set_Intelligence(kActorGordo, 80);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorLucy, 50);
		} else {
			Actor_Set_Intelligence(kActorLucy, 70);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorIzo, 65);
		} else {
			Actor_Set_Intelligence(kActorIzo, 85);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorDektora, 70);
		} else {
			Actor_Set_Intelligence(kActorDektora, 90);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorSteele, 70);
		} else {
			Actor_Set_Intelligence(kActorSteele, 90);
		}
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorSadik, 70);
		} else {
			Actor_Set_Intelligence(kActorSadik, 90);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorClovis, 80);
		} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorOfficerLeary, 40);
		} else {
			Actor_Set_Intelligence(kActorOfficerLeary, 60);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Actor_Set_Intelligence(kActorOfficerGrayford, 30);
		} else {
			Actor_Set_Intelligence(kActorOfficerGrayford, 50);
		}
	} else {
	...
	if (_vm->_cutContent) {
		if (Random_Query(1, 2) == 1) {
			Game_Flag_Set(kFlagGuzzaIsStupid);
		}
	}
